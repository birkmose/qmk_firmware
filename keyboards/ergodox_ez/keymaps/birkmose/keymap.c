 ...
 */
  [0] = LAYOUT_ergodox(
      ...
      KC_KP_SLASH,      KC_N,               KC_M,               KC_COMMA,   KC_DOT,         KC_SLASH,               KC_LALT,
                                            LGUI_T(KC_ESCAPE),  KC_DOWN,    KC_LBRACKET,    KC_RBRACKET,            KC_A,
      KC_LALT,          KC_RALT,
      TD(TD_PG_UP_HOME),
 ...
 */
  ...
  [2] = LAYOUT_ergodox(
    ...
    RALT(NO_LESS),  TILDE,                 NO_LBRC,                NO_RBRC,            KC_MEDIA_NEXT_TRACK,PT,                 PT,
